...
<html>
    <head>
        ...
        <script type="text/javascript" src="dwr/interface/CipherService.js"></script>
        <script type="text/javascript" src="js/cipher/app.js"></script>
        <script type="text/javascript" src="js/cipher/AddCipherPanel.js"></script>
    </head>
    <body>
        <div id="gridpanel"/>
    </body>
